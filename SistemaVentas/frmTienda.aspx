            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header">
                   <i class="fa fa-home"></i> Tiendas
                  </div>
                  <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                                <button id="btnNuevoTienda" type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i>   Nuevo</button>
                            </div>
                        </div>
                      <hr />
                        <div class="row mt-3">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-home"></i>   Tienda</h5>
