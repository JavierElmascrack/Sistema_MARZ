...
<body>
    ...
    <div id="seleccion">
        <center>
            <div>
                <table style="width: 700px; border:2px solid #000;padding: 10px;" border="0">
                    <tbody>
                        <tr>
                            
                            <td colspan="5" align="center" border="3">
                                <img height="140"  src="img/marz.jpg" style="width: 192px">
                            </td>
                            <td colspan="2" rowspan="3" align="center" style="vertical-align: top;" class="auto-style1">
                        ...
                        <tr>
                            <td colspan="6" align="right">Atendido por: <span id="nombreempleado"></span></td>
                        </tr>
                        <tr>
                            <td colspan="6" align="rigth">&nbsp;</td>
                        </tr>
                        <tr style="height: 20px;"><td colspan="6"><br /></td></tr>
                        <tr><td></td><td></td><td></td><td></td><td></td><td class="auto-style1"></td></tr>
                       <tr>
                           <td colspan="6">
                               <table style=" width: 100%;" border="0">
                                   ...
                                   <tr>
                                       <td style="width:50px">Nro.Identificador:</td>
                            ...
                            <td colspan="4">
                                <table width='250' border='1'>
                                    <tr style='border:1px solid black;'>
                                        <td bgcolor='#D9D9D9'>Pago con C$/.</td>
                                        <td><span id="importerecibido"></span></td>
                                        <td bgcolor='#D9D9D9'>Cambio C$/.</td>
