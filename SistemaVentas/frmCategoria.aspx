            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                                <button id="btnNuevoCategoria" type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i>  Nuevo</button>
                            </div>
                        </div>
                      <hr />
                        <div class="row mt-3">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-boxes"></i>   Categoria</h5>
