            ...
            <div class="col-sm-12">
               <div class="card">
                  ...
                  <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                                <button id="btnNuevoProducto" type="button" class="btn btn-sm btn-success"><i class="fa fa-plus"></i>   Nuevo</button>
                            </div>
                        </div>
                      <hr />
                        <div class="row mt-3">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-box-open"></i>  Producto</h5>
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group row">
                <label for="staticEmail" class="col-sm-2 col-form-label col-form-label-sm">Presentacion</label>
                <div class="col-sm-10">
