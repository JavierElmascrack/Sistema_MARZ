...
INSERT INTO MENU(Nombre,Icono) VALUES ('Mantenedor','fa fa-home'),('Provedores','fa fa-people-carry'),('Producto','fa fa-box'),('Usuario','fa fa-cogs'),('Compras','fa fa-shopping-basket'),('Ventas','fa fa-tags'),('Reportes','fa fa-tasks')
GO
...
INSERT INTO TIENDA(Nombre,RUC,Direccion,Telefono) VALUES ('Tienda MARZ','25689789654','Pista el Dorado','963852896')

GO
--REGISTROS USUARIO
insert into usuario(Nombres,Apellidos,Correo,Usuario,Clave,IdTienda,IdRol)
values('Javier','Flores','snk@gmail.com','Admin','Admin123',(select TOP 1 IdTienda from TIENDA where Nombre = 'Tienda 001'),(select TOP 1 IdRol from ROL where Descripcion = 'ADMINISTRADOR'))
go
insert into usuario(Nombres,Apellidos,Correo,Usuario,Clave,IdTienda,IdRol)
values('Cristofer','Lopez','snk@gmail.com','Tienda','Tienda123',(select TOP 1 IdTienda from TIENDA where Nombre = 'Tienda 001'),(select TOP 1 IdRol from ROL where Descripcion = 'EMPLEADO'))
